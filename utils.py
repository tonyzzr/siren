...
def write_psnr(pred_img, gt_img, writer, iter, prefix):
    ...
    for i in range(batch_size):
        ...
        # ssim = skimage.measure.compare_ssim(p, trgt, multichannel=True, data_range=1) # function renamed
        ssim = skimage.metrics.structural_similarity(p, trgt, win_size=3, multichannel=True, data_range=1)
