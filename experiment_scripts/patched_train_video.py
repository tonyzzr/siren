'''Reproduces Supplement Sec. 7 with patched FFmpeg support'''
...
# Import our FFmpeg fix and apply it before importing skvideo
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from fix_skvideo import fix_skvideo
fix_skvideo()
...
print(vid_dataset.__getitem__(0).shape) # in shape (f, h, w, c)
from matplotlib import pyplot as plt
plt.imshow(vid_dataset.__getitem__(0)[0])
plt.show()
input()
